(function buildIptvLanding() {
    ...
    var catList = [
        ['📺', 'آلاف القنوات', 'من جميع أنحاء العالم', 'https://images.unsplash.com/photo-1593640408182-31c70c8268f5?auto=format&fit=crop&w=300&q=80'],
        ['⚽', 'مباريات مباشرة', 'جميع الدوريات العالمية', 'https://images.unsplash.com/photo-1518605368461-1ee12db8bc55?auto=format&fit=crop&w=300&q=80'],
        ['🎬', 'أفلام', 'أحدث الأفلام العالمية', 'https://images.unsplash.com/photo-1489599849927-2ee91cede3ba?auto=format&fit=crop&w=300&q=80'],
        ['🎭', 'مسلسلات', 'أحدث المسلسلات', 'https://images.unsplash.com/photo-1536440136628-849c177e76a1?auto=format&fit=crop&w=300&q=80'],
        ['🧸', 'أطفال', 'ترفيه آمن لأطفالك', 'https://images.unsplash.com/photo-1566579090262-51cde5ebe92e?auto=format&fit=crop&w=300&q=80'],
        ['🏆', 'قنوات رياضية', 'جودة عالية بدون تقطيع', 'https://images.unsplash.com/photo-1579952363873-27f3bade9f55?auto=format&fit=crop&w=300&q=80']
    ];
    var cats = '';
    for (s = 0; s < catList.length; s++) cats += '<div class="_iptv_cat_card" style="background-image:url(' + catList[s][3] + ');"><div class="_iptv_cat_overlay"></div><div class="_iptv_cat_content"><span style="font-size:1.8rem;margin-bottom:4px;">' + catList[s][0] + '</span><h3>' + catList[s][1] + '</h3><p>' + catList[s][2] + '</p></div></div>';
    ...
    var devList = [['🤖', 'Android'], ['📺', 'Android TV'], ['🍎', 'Apple TV'], ['🖥️', 'LG Smart'], ['💻', 'Samsung'], ['🔥', 'Fire TV'], ['🪟', 'Windows'], ['📱', 'iPhone / iPad']];
    var devs = '';
    for (s = 0; s < devList.length; s++) devs += '<div class="_iptv_device_item"><div class="_iptv_device_icon">' + devList[s][0] + '</div><span class="_iptv_device_text">' + devList[s][1] + '</span></div>';
    ...
    var htmlString =
        ...
        '<section class="_iptv_container"><div class="_iptv_section_title_wrap"><div class="_iptv_title_line"></div><h2 class="_iptv_section_title">كل ما تحب.. في مكان واحد</h2><div class="_iptv_title_line"></div></div><div class="_iptv_grid_6 _iptv_reveal">' + cats + '</div></section>' +
        ...
        '<section class="_iptv_container"><div class="_iptv_section_title_wrap"><div class="_iptv_title_line"></div><h2 class="_iptv_section_title">الأجهزة المتوافقة</h2><div class="_iptv_title_line"></div></div><div class="_iptv_devices_wrap _iptv_reveal">' + devs + '</div></section>' +

        '<section id="pricing" class="_iptv_container"><div class="_iptv_section_title_wrap"><div class="_iptv_title_line"></div><h2 class="_iptv_section_title">الباقات والأسعار</h2><div class="_iptv_title_line"></div></div><div class="_iptv_grid_3 _iptv_reveal">' +
        '<div class="_iptv_price_card"><div class="_iptv_price_months">6 أشهر</div><div class="_iptv_price_value">199 <span class="_iptv_price_currency">ريال</span></div><ul class="_iptv_price_features"><li>جهاز واحد</li><li>جودة 4K - FULL HD</li><li>جميع القنوات والمحتوى</li></ul><a href="/products" class="_iptv_btn_outline" style="width:100%;">اشترك الآن</a></div>' +
        '<div class="_iptv_price_card"><div class="_iptv_price_months">12 شهر</div><div class="_iptv_price_value">299 <span class="_iptv_price_currency">ريال</span></div><ul class="_iptv_price_features"><li>جهاز واحد</li><li>جودة 4K - FULL HD</li><li>جميع القنوات والمحتوى</li><li>تحديث يومي</li></ul><a href="/products" class="_iptv_btn_primary" style="width:100%;">اشترك الآن</a></div>' +
        '<div class="_iptv_price_card _iptv_price_card_popular"><div class="_iptv_ribbon">الأكثر مبيعاً</div><div class="_iptv_price_months">15 شهر</div><div class="_iptv_price_value">349 <span class="_iptv_price_currency">ريال</span></div><ul class="_iptv_price_features"><li>جهاز واحد</li><li>جودة 4K - FULL HD</li><li>جميع القنوات والمحتوى</li><li>تحديث يومي</li><li>دعم فني 24/7</li></ul><a href="/اشتراك-سمارترز/34983" class="_iptv_btn_primary" style="width:100%;">اشترك الآن</a></div>' +
        '</div></section>' +

        '<section class="_iptv_container"><div class="_iptv_section_title_wrap"><div class="_iptv_title_line"></div><h2 class="_iptv_section_title">آراء عملائنا</h2><div class="_iptv_title_line"></div></div><div class="_iptv_grid_4 _iptv_reveal">' + revs + '</div></section>' +
        ...
        '</div></div>' +
        '<div class="_iptv_footer_col"><h4>روابط سريعة</h4><ul class="_iptv_footer_links"><li><a href="#">الرئيسية</a></li><li><a href="#pricing">الباقات</a></li><li><a href="#">القنوات</a></li><li><a href="#">الأفلام</a></li></ul></div>' +
        ...
        '<a href="tel:+966530554953" class="_iptv_fab" aria-label="اتصل بنا"><svg width="26" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07 19.5 19.5 0 0 1-6-6 19.79 19.79 0 0 1-3.07-8.67A2 2 0 0 1 4.11 2h3a2 2 0 0 1 2 1.72 12.84 12.84 0 0 0 .7 2.81 2 2 0 0 1-.45 2.11L8.09 9.91a16 16 0 0 0 6 6l1.27-1.27a2 2 0 0 1 2.11-.45 12.84 12.84 0 0 0 2.81.7A2 2 0 0 1 22 16.92z"></path></svg></a>' +
        '</div>' +
